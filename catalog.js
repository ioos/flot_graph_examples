var catalog = {
    ...
    'CRCOOS' : {
      'CAP2' : {
        ...
        ,'getObs' : function(v,year) {
          ...
          return 'get.php?http://tds.secoora.org/thredds/sos/carocoops.cap2.buoy.nc?request=GetObservation&service=SOS&version=1.0.0&responseFormat=text/xml;schema%3D"om/1.0.0"&offering=urn:ioos:network:org.secoora:all&procedure=urn:ioos:network:org.secoora:all' + '&eventTime=' + year + '-01-01T00:00:00Z/' + year + '-12-31T23:59:59Z' + '&observedProperty=' + n2o[v];
        }
      }
      ,'FRP2' : {
  ...
  ,'models' : {
    'SABGOM' : {
      'getObs' : function(v,year,lon,lat) {
        var n2o = {
           'Temperature' : 'temp'
          ,'Salinity'    : 'salt'
        };
        return 'get.php?' + 'http://tds.secoora.org/thredds/ncss/grid/clim_daily_avg_surface.nc?var=' + n2o[v] + '&latitude=' + lat + '&longitude=' + lon + '&time_start=' + year + '-01-01T00:00:00Z&time_end=' + year + '-12-31T23:59:59Z&accept=xml&vertCoord=-0.986111111111111';
      }
      ,'wkt' : ''
    }
  }
